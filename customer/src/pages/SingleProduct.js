...
const SingleProduct = () => {
  ...
  // biến xác định xem có trong giỏ hàng hay chứa
  ...
  const props = {
    ...
    img: productState?.images[0]?.url
      ...
      : "https://bizweb.dktcdn.net/thumb/1024x1024/100/348/234/products/jp01.jpg",
  };
              ...
              <div className="border-bottom">
                ...
                <div className="d-flex gap-15 align-items-center flex-row mt-2 mb-3">
                  ...
                  >
                    ...
                    <Link to="/signup" className="button signup mx-2 ">
                      BUY IT NOW
                    </Link>
                  </div>
                </div>

                {/* so sánh và thêm vào sản phẩm yêu thích */}
                ...
                <div className="d-flex gap-10 align-items-center my-3">
                  ...
                  <a
                    ...
                    onClick={() => {
                      copyToClipboard(
                        "http://localhost:3000/images/main-banner-1.jpg"
                      );
                    }}
                  >
                    Copy Product Link
